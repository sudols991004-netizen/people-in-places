...
const kakaoShippingModal = document.getElementById('kakaoShippingModal');
...
function checkLoginReady() {
  if (loginSubmitBtn) loginSubmitBtn.disabled = !(loginEmailInput.value.trim() && loginPasswordInput.value.trim());
}
